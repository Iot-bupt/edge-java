...
@Component
public class PingMetaDataClientImpl extends ConsulDiscoveryClientTemplate
    implements PingMetaDataClient {

  @Value("${meta.db.ping.url}")
  private String url;
  ...
  private PingMetaDataClient getClient() {
    ...
    return target.proxy(PingMetaDataClient.class);
  }
  ...
  protected String extractPath() {
    ...
    try {
      ...
      throw new DataValidationException("the URL is malformed, meta.db.ping.url: " + url);
    }
    return result;
  }
