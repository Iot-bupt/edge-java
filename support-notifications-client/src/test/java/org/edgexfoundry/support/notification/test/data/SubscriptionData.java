...
public interface SubscriptionData {
  ...
  static final String TEST_SLUG = "TEST_SLUG.SUBSCRIPTION.NAME";
  static final String TEST_REC = "edgex_some_receiver";
  static final String TEST_DESC = "test description";
  static final NotificationCategory[] TEST_CATS =
      {NotificationCategory.SW_HEALTH, NotificationCategory.HW_HEALTH};
  static final String[] TEST_CAT_STR = {"HW_Health", "SW_HEALTH"};
  static final String[] TEST_LABELS = {"test", "edgex", "normal"};
